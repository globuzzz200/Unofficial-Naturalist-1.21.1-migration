...
import com.starfish_studios.naturalist.Naturalist;import net.minecraft.world.level.block.Blocks;
...
public class Hippo extends NaturalistAnimal implements NaturalistGeoEntity {
    ...
    protected ResourceKey<LootTable> getDefaultLootTable() {
        return ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(Naturalist.MOD_ID, "entities/hippo"));
    }
    ...
    public int getMaxAirSupply() {
        return 6000; // 5 minutes of air underwater
    }
    ...
    private <E extends Hippo> PlayState predicate(final @NotNull AnimationState event) {
    ...
    private <E extends Hippo> PlayState attackPredicate(final AnimationState event) {
